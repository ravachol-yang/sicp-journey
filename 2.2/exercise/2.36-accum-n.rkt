...
;; It applies the designated accumulation procedure to combine all the first elements of the sequences, all the second elements of the sequences, and so on,
;; and returns a sequence of the results. For instance, if s is a sequence containing four sequences,
